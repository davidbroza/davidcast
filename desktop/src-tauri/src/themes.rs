...
fn gameboy_theme() -> Theme {
    ...
    Theme {
        ...
        tokens: tokens! {
            ...
            "badge-docker" => "#306230",
            "badge-logs" => "#578a34",
            "shadow" => "0 28px 80px rgba(15, 56, 15, 0.55), 0 0 0 1px #0f380f",
            "font-family" => FONT_TERMINAL,
            "font-family-mono" => FONT_TERMINAL,
        },
    }
...
fn pokemon_theme() -> Theme {
    ...
    Theme {
        ...
        tokens: tokens! {
            ...
            "bg-solid" => "#fff8e8",
            "bg-image" => "radial-gradient(circle at 0% 0%, rgba(232, 28, 28, 0.12), transparent 40%), radial-gradient(circle at 100% 100%, rgba(60, 88, 168, 0.12), transparent 40%)",
            "bg-row" => "transparent",
            ...
            "badge-docker" => "#3c58a8",
            "badge-logs" => "#5a5a64",
            "shadow" => "0 28px 80px rgba(0, 0, 0, 0.4), 0 0 0 1px rgba(28, 28, 36, 0.4)",
            "font-family" => FONT_TERMINAL,
            "font-family-mono" => FONT_TERMINAL,
        },
    }
